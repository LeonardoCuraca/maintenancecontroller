  ...
  render() {
    return (
      <Modal
        ...
        style={{ maxWidth: "75%" }}
      >
        <ModalHeader style={{ backgroundColor: "#574949", color: "#fff" }}>Observaciones de Servicio</ModalHeader>
        <ModalBody>
          <Form autocomplete="off">
            <Row>
              ...
              <Col lg="12">
                <Input type="text" name="chofer" defaultValue={this.state.review} id="chofer" onChange={this.changeDescription.bind(this)}/>
              </Col>
            </Row>
